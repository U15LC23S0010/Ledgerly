...
export default function Topbar({ onMenuClick = () => {} }) {
  ...
  function getPageTitle() {
    ...
    if (pathname.startsWith("/auto-expense")) return "Auto Expense";
  ...
  return (
    <header className="topbar">
      ...
      <div className="topbar-search-wrapper" ref={searchWrapperRef}>
        <form
          className={`topbar-search ${showSearchResults ? "search-open" : ""}`}
                  ...
                  {searchResults.map((transaction) => {
                    ...
                    return (
                      <button
                        ...
                        key={transaction.id}
                        onClick={() =>
                          handleSearchResultClick(transaction)
                        }
                      >
      ...
      <div className="topbar-actions">
        ...
        <div className="profile-wrapper">
          <button
            type="button"
            className={`profile ${profileOpen ? "profile-open" : ""}`}
          ...
          >
            ...
            <ChevronDown className={profileOpen ? "rotate" : ""} />
          </button>
          ...
          {profileOpen && (
            <div className="profile-dropdown" role="menu">
              <div className="profile-dropdown-header">
                ...
                <div>
                  <strong>{username}</strong>
                  <span>{email || "Personal account"}</span>
                </div>
              </div>
